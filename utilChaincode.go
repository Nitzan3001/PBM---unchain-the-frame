...
func readCallerDetails(stubPointer *shim.ChaincodeStubInterface) (CallerDetails, error) {
	...
	orgBytes, err := stub.ReadCertAttribute("BorderManagement")
	if err != nil {
		callerDetails.BorderManagement = ""
	} else {
		callerDetails.BorderManagement = string(orgBytes)
	}
...
func validatePassportTypeCode(code string) (bool, error) {
